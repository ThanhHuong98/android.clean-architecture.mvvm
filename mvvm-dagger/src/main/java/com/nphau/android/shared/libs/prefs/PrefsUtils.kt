...
package com.nphau.android.shared.libs.prefs
...
import com.nphau.android.shared.libs.encryption.toBASE64
...
class PrefsUtils @Inject constructor() : PluginInitializer {
    ...
    @Synchronized
    override fun initialize(application: com.nphau.android.Launcher) {
