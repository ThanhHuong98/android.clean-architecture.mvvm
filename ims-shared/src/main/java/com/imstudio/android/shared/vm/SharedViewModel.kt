...
import com.imstudio.android.shared.common.functional.Result
import com.imstudio.android.shared.data.error.ServerError
import com.imstudio.android.shared.data.error.toServerError
...
open class SharedViewModel : ViewModel(), HasDisposableManager {
    ...
    private val _commonTask: MutableLiveData<Result<Boolean, ServerError>> = MutableLiveData()
